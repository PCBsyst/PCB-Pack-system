...
export function DocumentRuleSettings() {
  ...
  const initial = profiles.map((profile) => { const item = saved.find((savedItem) => profileKey(savedItem) === profileKey(profile)) ?? profile; return { ...item, rules: { ...item.rules, education: "REQUIRED" as const } }; });
