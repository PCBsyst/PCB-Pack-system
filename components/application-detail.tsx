...
import { buildDocuments, createZip, downloadBlob, downloadDecisionReportDocx, downloadWord, printAsPdf, type AssessmentResult, type DemoAssessment, type DemoCertificate, type DemoDecision, type DemoEnglishText, type DemoPanelMember, type DemoReview, type DocumentLanguage } from "@/lib/prototype-package";
