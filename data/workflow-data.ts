...
export const applications: CertificationApplication[] = [
  ...
  {
    id: "app-003", applicationNo: "APP-ISO-2026-073", candidateId: "cand-003", businessArea: "ISO", accreditationTrack: "NON_ACCREDITED", applicationType: "갱신", receivedAt: "2026-08-15", registeredAt: "2026-08-16 14:30", partnerCompany: "직접접수", status: "COMPLETED", managementNoFrom: 1288, managementNoTo: 1288, jobIds: ["job-003"], primaryOwner: "김담당", dropboxFolderName: "1288 이영희 (LA 45001 갱신)", dropboxPath: "/GPC/ISO/2026/1288 이영희 (LA 45001 갱신)", documentsStored: true, packageStatus: "GENERATED", invoiceIds: ["invoice-002"],
  },
  {
...
export const packageDocuments: PackageDocument[] = [
  ...
  { id: "pkg-5", jobId: "job-003", type: "DOCUMENT_REVIEW", title: "ISO 서류검토서", formats: ["WORD", "PDF"], status: "GENERATED", templateVersion: "ISO-DR v1" },
  { id: "pkg-6", jobId: "job-003", type: "CERTIFICATION_DECISION_REPORT", title: "ISO 인증결정보고서", formats: ["WORD", "PDF"], status: "GENERATED", templateVersion: "ISO-CDR v1" },
  { id: "pkg-7", jobId: "job-003", type: "DELIVERY_CONFIRMATION", title: "문서전달확인서", formats: ["WORD", "PDF"], status: "GENERATED", templateVersion: "ISO-DD v1" },
  { id: "pkg-8", jobId: "job-003", type: "CERTIFICATE", title: "ISO 45001 인증서 Rev.0", formats: ["PDF"], status: "GENERATED", templateVersion: "Certificate v1" },
];
